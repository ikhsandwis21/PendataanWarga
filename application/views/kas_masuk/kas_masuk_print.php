...
<html> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>LAPORAN DATA KAS MASUK</title>
      ...
      <table align="center" width="100%" border="0.3" cellpadding="0" cellspacing="0">
        <thead style="background:#e8ecee">
          <tr class="tr-title">
            ...
            <th height="23" align="center" valign="middle">Asal Dana</th>
            <th height="25" align="center" valign="middle">Jumlah</th>
            <th height="25" align="center" valign="middle">Saldo Saat Ini</th>
            <th height="25" align="center" valign="middle">Tanggal Masuk</th>
    ...
    if( ! empty($kas)){
        ...
        echo "  <tr>
                    ...
                    <td width='110' height='13' align='center' valign='middle'>$data->asal_dana</td>
                    <td width='120' height='13' align='center' valign='middle'>$data->jumlah</td>
                    <td width='120' height='13' align='center' valign='middle'>$data->saldo</td>
                    <td width='120' height='13' align='center' valign='middle'>$data->tanggal</td>
                    </tr>
